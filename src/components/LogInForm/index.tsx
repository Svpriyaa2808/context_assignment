...
const LogInForm = () => {
    ...
    return (
        <>
        <Header />
        <div className="grow flex flex-col justify-center ml-2 m-4">
        <form className="flex flex-col max-w-[400px] rounded-2xl border-amber-800 border-2 ml-2  sm:m-auto shadow-2xl my-4  p-4">
